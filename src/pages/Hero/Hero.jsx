...
export default function Hero() {
  const words = [
    ...
    // "Full-Stack Developer & AI-App Development",
    // "JavaScript & Python & Go Developer",
    // "Learning MARN Stack",
    // "Linux & GitHub",
  ];
...
const profile = {
    ...
    skills: [
        'React', 'NextJS' ,'Vue.js', 'Tailwind CSS'
        'Django', 'Flask', 'FastAPI', 'Node.js', 'Laravel'
        'MySQL', 'MongoDB', 'Docker', 'AWS', 'TypeScript'
        'GraphQL', 'Git', 'Linux', 'ASP.NET','Express'
        'N8N', 'Zapier', 'RAG', 'MCP', 'LLM', 'Langchain'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
          ...
          >
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-6 sm:mb-8">
                <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-tight">
                  ...
                  <span className="relative inline-block">
                    <span className="typing-effect gradient-text text-5xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/sunnydev830"
